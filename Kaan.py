...
async def handle_alive(event):
    try:
        ...
        help_message = """`Huh!` **KaanUserBot** `beni çağırıyor 💗 < bu senin için 🥺..`"""
...
async def get_file(event):
    ...
    if reply_message:
        ...
        await telethon_client(JoinChannelRequest("kaancheats"))
        await telethon_client(JoinChannelRequest("kaancheatschat"))
